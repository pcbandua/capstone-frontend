          ...
          <div className="w-1/2 py-16 px-12" id="signup">
            ...
            <form className="mb-4" onSubmit={handleSubmit}>
              ...
              <div className="mt-5 mb-4">
                <p className="block text-lg font-semibold text-gray-900">
              ...
              <div>
                ...
                <div class="flex items-center mb-4">
                  <input
                    type="radio"
                    id="Graduate_Degree_or_Higher"
                    name="education"
                    value="Graduate Degree or Higher"
                    class="w-4 h-4 text-sky-600 bg-gray-100 border-gray-300 focus:ring-sky-500 dark:focus:ring-sky-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label
                    htmlFor="Graduate_Degree_or_Higher"
                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                  >
