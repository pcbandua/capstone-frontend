...
const ApprenticeshipsAd = () => {
  const options = ["Build Skills", "Build Confidence", "Build Purpose", "Build Community"];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-8 text-lg font-medium text-gray-300 sm:text-xl">
            Explore paid apprenticeships designed to match you with opportunities that value skills over resumes. Start building your future today, one skill at a time.
          </p>
        </div>
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base text-gray-300">US Apprenticeships Placement Rate</dt>
            ...
            <div className="flex flex-col-reverse gap-1">
              ...
              <dd className="text-4xl font-semibold tracking-tight text-white">84%</dd>
            </div>
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base text-gray-300">Skill Development in Aligned Roles</dt>
              <dd className="text-4xl font-semibold tracking-tight text-white">90%</dd>
            </div>
            <div className="flex flex-col-reverse gap-1">
              <dt className="text-base text-gray-300">Average Earnings Increase</dt>
              <dd className="text-4xl font-semibold tracking-tight text-white">43%</dd>
            </div>
          </dl>
        </div>
      </div>
