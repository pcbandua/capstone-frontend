...
export function ApprenticeshipsIndex({ apprenticeships, onShow }) {
  ...
  const filteredApprenticeships = apprenticeships.filter((apprenticeship) => {
    const matchesSearchTerm = apprenticeship.title
      .toLowerCase()
  ...
  const currentApprenticeships = filteredApprenticeships.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
      ...
      <div className="py-6 max-md:col-span-2 mx-auto" id="signup">
              ...
              <div className="dropdowns flex gap-5">
                ...
                <div className="flex-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setSelectedHollandCodePreference(e.target.value)
                    }
                  >
                    <option value="">Holland Code</option>
                    {hollandCodePreferences.map((hollandCodePreference) => (
                      <option
                        key={hollandCodePreference}
                        value={hollandCodePreference}
                      >
        ...
        <div className="py-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {currentApprenticeships.map((apprenticeship) => (
            <Card
              ...
              className="w-12/12 mb-2 flex flex-col h-full"
            >
              <div>
                <CardHeader>
              ...
              <CardContent className="flex-grow">
                ...
                <p>
                  <b>Hourly Pay Rate:</b> {apprenticeship.compensation}
                </p>
                <p>
                  <b>Time Commitment:</b> {apprenticeship.duration}
                </p>
              </CardContent>
              <CardFooter>
        ...
        <div className=" gap-4">
          <div className="pagination-controls container mx-auto items-center justify-center">
            <Button
              className="bg-slate-200 text-slate-900 px-4 text-lg hover:bg-lime-600 mt-5"
