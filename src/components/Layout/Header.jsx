      ...
      <nav className="container mx-auto flex items-center justify-between p-6 lg:px-8 text-" aria-label="Global">
        ...
        <div className="flex lg:flex-1">
          <Link to="/" className="-m-1.5 p-1.5">
            ...
            <img className="h-8 w-auto" src="src/assets/Logo@2x.png" alt="Logo" />
          </Link>
        </div>
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Link to="/" className="block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Home</Link>
                <Link to="/view-apprenticeships" className="block rounded-lg px-3 py-2 text-base font-semibold text-gray-900 hover:bg-gray-50">Apprenticeships</Link>
              </div>
              <div className="py-6">
                {authenticationLinks}
              </div>
