      ...
      >
        ...
        <div className="relative z-10 text-white mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 ">
          <div className="text-center">
            ...
            <p className="mt-8 text-pretty text-lg font-medium text-gray-100 sm:text-xl/8">
              We’re a skills-first platform offering paid apprenticeships to
              help you reach your potential. No resumes, no barriers—just real
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff3a75] to-[#14cef3] opacity-0 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
      </div>
    </div>
